...
def process_extended_smotif(pdb_file, sse1, sse2):
    try:
        ...
        smotif_id = f"{smotif_type}_{sse1['SSE1_Length']}_{sse2['SSE1_Length']}_{com_bin}_{loop_length}"
        #print (smotif_id)
...
# Usage
smotif_csv = 'smotif_database.csv'
pdb_dir = 'pdb_files'
output_file = 'processed_extended_smotif_database.csv'
