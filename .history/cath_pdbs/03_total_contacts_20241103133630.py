...
def process_dataframe(input_file, output_file, pdb_folder):
    ...
    df = df[['smotif_id' ,'smotif_type', 'domain', 'sse1_type', 'sse2_type', 'sse1_seq',
 'sse2_seq', 'sse1_length', 'sse2_length', 'SSE1_start', 'SSE1_end',
 'SSE2_start', 'SSE2_end', 'loop_length', 'com_distance', 'com_bin', 'total_contacts' ]]
