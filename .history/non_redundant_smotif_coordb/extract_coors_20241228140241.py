...
if __name__ == "__main__":
    csv_directory = "path/to/csv/files"  # Directory containing CSV files
    pdb_directory = "path/to/pdb/files"  # Directory containing original PDB files
    output_directory = "path/to/output"  # Directory for output files
